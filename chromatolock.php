...
if(strpos($_SERVER['HTTP_USER_AGENT'], 'iPhone') || strpos($_SERVER['HTTP_USER_AGENT'],'iPad' ) || strpos($_SERVER['HTTP_USER_AGENT'], 'iPod' ) !== false){
    if (strpos($_SERVER['HTTP_USER_AGENT'], 'OS 7_1_2')  || strpos($_SERVER['HTTP_USER_AGENT'], 'OS 7_1_1') || strpos($_SERVER['HTTP_USER_AGENT'], 'OS 7_1') || strpos($_SERVER['HTTP_USER_AGENT'], 'OS 7_0') == true) {
...
<html>
	<head>
		<title>
			Chromatolock | CP Digital Darkroom's Lab
		</title>
	...
	<body>
		...
		<div id="container">
			...
			<div id="contentSingle">
				...
				<h2 class="repoDescriptionHeader">&nbsp;&nbsp;Chromatolock</h3>
			...
			<div id="contentBottom">
				<ul>
					...
					<li><p>Added more depends in the control file to prevent installations in unsupported firmwares</p></li>
				</ul>			
			</div>
			...
			<div id="contentBottom">
				<ul>
					<li><p>Don't you just hate it when the LockScreen sets it's text to white on top of your white background? Chromatolock makes it easy to set your own custom color for clock and status bar.<br><br>If you find a new bug, please report it by tapping the &ldquo;Author&rdquo; button above.</p></li>
					<hr>
					<li>
