...
<html>
	<head>
		<title>
			GoblinCleaver | CP Digital Darkroom's Lab
		</title>
	...
	<body>
		...
		<div id="container">
			...
			<div id="contentSingle">
				...
				<h2 class="repoDescriptionHeader">&nbsp;&nbsp;GoblinCleaver</h3>
			...
			<div id="contentBottom">
				<ul>
					<li><p>GoblinCleaer is a mod tweak for the game Goblin Sword. Currently it only makes you invincible but more options will be added soon.<br><br>If you find a new bug, please report it by tapping the &ldquo;Author&rdquo; button above.</p></li>
					<hr>
					<li>
