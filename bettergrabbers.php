...
<html>
	<head>
		<title>
			BetterGrabbers | CP Digital Darkroom's Lab
		</title>
	...
	<body>
		...
		<div id="container">
			...
			<div id="contentSingle">
				...
				<h2 class="repoDescriptionHeader">&nbsp;&nbsp;BetterGrabbers</h3>
			...
			<div id="contentBottom">
				<ul>
					<li><p>BetterGrabbers moves the NC and CC grabbers to be slightly offscreen in a aesthetically pleasing manner.<br><br>If you find a new bug, please report it by tapping the &ldquo;Author&rdquo; button above.</p></li>
					<hr>
					<li>
