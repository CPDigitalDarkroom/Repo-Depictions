...
<html>
	<head>
		<title>
			CCDeseparator | CP Digital Darkroom's Lab
		</title>
	...
	<body>
		...
		<div id="container">
			...
			<div id="contentSingle">
				...
				<h2 class="repoDescriptionHeader">&nbsp;&nbsp;CCDeseparator</h3>
			...
			<div id="contentBottom">
				<ul>
					...
					<li><p>Update to fix iOS 7.1.2 not being included in the group initialization</p></li>
				</ul>			
			</div><!--Close Package Header Div-->
			...
			<div id="contentBottom">
				<ul>
					<li><p>CCDeseparator is an extremely easy to use tweak which simply removes the separator lines in the Control Center.<br><br>If you find a new bug, please report it by tapping the &ldquo;Author&rdquo; button above.</p></li>
					<hr>
					<li>
