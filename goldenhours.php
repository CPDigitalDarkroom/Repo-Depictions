...
<html>
	<head>
		<title>
			Golden Hours | CP Digital Darkroom's Lab
		</title>
	...
	<body>
		...
		<div id="container">
			...
			<div id="contentSingle">
				...
				<h2 class="repoDescriptionHeader">&nbsp;&nbsp;Golden Hours</h3>
			...
			<div id="contentBottom">
				<ul>
					...
					<li><p>Added support for iOS 8</p></li>
					<li><p>Auto location detection</p></li>
				</ul>			
			</div><!--Close Package Header Div-->
			...
			<div id="contentBottom">
				<ul>
					<li><p>Knowing exactly when the sun goes rises or sets is important to photographers. Sometimes it can even be the difference between an awful picture and a National Geographic winning photograph. Golden Hours puts this information in the slide to unlock view.<br><br>If you find a new bug, please report it by tapping the &ldquo;Author&rdquo; button above.</p></li>
					<hr>
					<li>
