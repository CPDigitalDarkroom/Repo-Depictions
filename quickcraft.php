...
<html>
	<head>
		<title>
			QuickCraft | CP Digital Darkroom's Lab
		</title>
	...
	<body>
		...
		<div id="container">
			...
			<div id="contentSingle">
				...
				<h2 class="repoDescriptionHeader">&nbsp;&nbsp;QuickCraft</h3>
			...
			<div id="contentBottom">
				<ul>
					<li><p>QuickCraft is a Minecraft mod tweak which adds various enhancements for easier play on survival.<br><br>If you find a new bug, please report it by tapping the &ldquo;Author&rdquo; button above.</p></li>
					<hr>
					<li>
